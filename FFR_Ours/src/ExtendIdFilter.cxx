...
vtkStandardNewMacro(ExtendIdFilter);

// Construct object with PointIds and CellIds on; and ids being generated
// as scalars.
// Note the ids returned by this extended version is actually id+1
ExtendIdFilter::ExtendIdFilter()
{
  this->PointIds = 1;
  this->CellIds = 1;
  this->FieldData = 0;
  this->IdsArrayName = NULL;
  this->SetIdsArrayName("ExtendIdFilter_Ids");
}
...
//
int ExtendIdFilter::RequestData(
...
void ExtendIdFilter::PrintSelf(ostream& os, vtkIndent indent)
{
